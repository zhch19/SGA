...
from model.faster_rcnn.faster_rcnn_auto  import _fasterRCNN
...
class netD1(nn.Module):
	...
	self.bn0 = nn.BatchNorm2d(256)
        ...
        self.conv2 = conv3x3(256, 256, stride=2)
        self.bn2 = nn.BatchNorm2d(256)
        self.conv3 = conv3x3(256, 256, stride=2)
        self.bn3 = nn.BatchNorm2d(256)
        self.conv4 = conv3x3(256, 256, stride=2)
        self.bn4 = nn.BatchNorm2d(256)
        self.conv5 = conv3x3(256, 256, stride=2)
...
class resnet(_fasterRCNN):
  ...
  def _init_modules(self):
    ...
    # Build resnet.
    #self.RCNN_base0 = nn.Sequential(resnet.conv1, resnet.bn1, resnet.relu, resnet.maxpool)
    ...
    self.netD1 = netD1(context=self.gc)
    self.netD2 = netD2(context=self.gc)
    self.netD3 = netD3(context=self.gc)
    self.netDisCal = SPPLayer()
